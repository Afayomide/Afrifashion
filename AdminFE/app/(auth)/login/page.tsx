    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 to-indigo-900 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Afro Royals</h1>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="admin@afroroyals.com"
                  value={email}
        ...
        <div className="mt-4 text-center text-sm text-blue-200">
          <p>Demo credentials: admin@afroroyals.com / admin123</p>
        </div>
      </div>
    </div>
  );
